...
{
	[Serializable]
	[Model("com.axelor.apps.base.db.AppRecruitment")]
	public class AppRecruitment : AxelorModel
	{
		...
		[JsonProperty("lastEmailId")]
		[Field("lastEmailId", false, null, Int32.MaxValue)]
		public string? LastEmailId;
