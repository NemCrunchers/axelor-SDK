...
{
	[Serializable]
	[Model("com.axelor.apps.base.db.AppHelpdesk")]
	public class AppHelpdesk : AxelorModel
	{
		...
		[JsonProperty("manageTimer")]
		[Field("manageTimer", false, "False", Int32.MaxValue)]
		...
		[JsonProperty("isSla")]
		[Field("isSla", false, "False", Int32.MaxValue)]
		public bool? IsSla;
