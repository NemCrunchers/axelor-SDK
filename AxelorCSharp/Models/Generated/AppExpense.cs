...
{
	[Serializable]
	[Model("com.axelor.apps.base.db.AppExpense")]
	public class AppExpense : AxelorModel
	{
		...
		[JsonProperty("computeDistanceWithWebService")]
		[Field("computeDistanceWithWebService", false, "False", Int32.MaxValue)]
		public bool? ComputeDistanceWithWebService;
