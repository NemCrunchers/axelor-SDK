...
namespace Axelor.Apps.Production.Db
{
	...
	public class ConfiguratorProdProcess : AxelorModel
	{
		...
		[JsonProperty("configuratorProdProcessLineList")]
		[Field("configuratorProdProcessLineList", false, null, Int32.MaxValue)]
		public IEnumerable<Axelor.Apps.Production.Db.ConfiguratorProdProcessLine>? ConfiguratorProdProcessLineList;
