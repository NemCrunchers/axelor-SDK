...
{
	[Serializable]
	[Model("com.axelor.apps.base.db.Canton")]
	public class Canton : AxelorModel
	{
		...
		[JsonProperty("inhabitantsNbr")]
		[Field("inhabitantsNbr", false, "0", Int32.MaxValue)]
		public int? InhabitantsNbr;
