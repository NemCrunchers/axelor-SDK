...
{
	[Serializable]
	[Model("com.axelor.apps.base.db.AppEmployee")]
	public class AppEmployee : AxelorModel
	{
		...
		[Field("payrollPreparation", false, "False", Int32.MaxValue)]
		public bool? PayrollPreparation;
		...
		[JsonProperty("advanceManagement")]
		[Field("advanceManagement", false, "True", Int32.MaxValue)]
		public bool? AdvanceManagement;
		...
		[JsonProperty("employeeBonus")]
		[Field("employeeBonus", false, "False", Int32.MaxValue)]
		public bool? EmployeeBonus;
		...
		[JsonProperty("lunchVoucher")]
		[Field("lunchVoucher", false, "False", Int32.MaxValue)]
